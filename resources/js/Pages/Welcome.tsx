...
import {SectionLeftComposed, SectionRightComposed} from "@/Components/lib/composed/SectionComposed";
 ...
 * @returns JSX.Element
 */
export default function Welcome({auth, movies}: PageProps<{ movies: Movie[] }>) {
    /**
     ...
     */
    const {heroComposedProps, featuredSectionProps, section2Props, section3Props, section4Props, ctaComposedProps} =
