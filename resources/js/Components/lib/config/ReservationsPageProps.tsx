...
export function generateReservationsPageProps(
    ...
    const tableProps: TableProps<ExtendedReservation> = {
        ...
        renderCell: (item: ExtendedReservation, columnKey: Key) => {
            switch (columnKey) {
                case "movie":
                    return (
                ...
                case "showtime":
                    return (
                        <span className="text-xs">
                            {item.display_time.time_start} -{" "}
                            {item.display_time.time_end}
                        </span>
                    );
                case "seat":
                    return (
                    ...
                    return (
                        <ButtonGroup>
                            <Button
                                ...
                                variant="flat"
                                startContent={
                                    <LinkIcon className="text-foreground-500 size-4" />
                                }
                            >
                                View
                            </Button>
                            <Button
                                ...
                                size="sm"
                                startContent={
                                    <Trash className="text-foreground-500 size-4" />
                                }
                                variant="flat"
