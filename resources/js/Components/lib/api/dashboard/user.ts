 ...
 */
export const createUser = createApiRequest(async function createUser(
 ...
 */
export const editUser = createApiRequest(async function editUser(
    userId: number,
    userData: Partial<User>
): Promise<{
    success: boolean;
 ...
 */
export const deleteUser = createApiRequest(async function deleteUser(
    userId: number
