...
export type DashboardPageProps<T extends { id: number; name?: string }> =
    PageProps & {
        hasMore: boolean;
            ...
            <div className="p-4 lg:px-8">
                ...
                <LandingText
                    classNames={{
                        ...
                        bottomContent:
                            "w-full overflow-x-scroll max-md:w-[90vw]",
                    }}
                    orientation="left"
                    size="sm"
                ...
                {selectedItem && editForm && (
                    <>
                        <LandingText
                            ...
                            subtitle={
                                text.editSubtitle ||
                                "Modify the details of the selected item below."
                            }
                            bottomContent={
                                <Form
